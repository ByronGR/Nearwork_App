...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${poppins.className} ${jetbrainsMono.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col">{children}<VersionBanner /></body>
      <Script id="posthog-init" strategy="afterInteractive">{`
        ...
        posthog.init("phc_nYb2G6jySuJgxmmc55d9jMfT5TyuxpBGbgbZAGfYb7Ep",{api_host:"https://us.i.posthog.com",person_profiles:"identified_only"});
      `}</Script>
    </html>
  );
}
