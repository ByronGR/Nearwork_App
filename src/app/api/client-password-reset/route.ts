...
export async function POST(request: Request) {
  try {
    ...
    const publicMessage = message.includes("Firebase Admin credentials")
      ? "Client portal password reset is not fully connected yet. Nearwork needs to add Firebase Admin credentials to the App Vercel project."
      : message;
